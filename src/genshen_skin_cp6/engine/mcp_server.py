# -*- coding: utf-8 -*-
"""
原神 CP 壁纸套件 6 —— MCP (Model Context Protocol) 服务器
...
注册示例(任选其一):
  claude mcp add genshen-cp6 -- genshen-cp6-mcp
  # 或写入 .mcp.json / mcp_servers.json:
  {"mcpServers": {"genshen-cp6": {"command": "genshen-cp6-mcp", "args": []}}}
...
TOOLS = [
    ...
    },
    {
        ...
        "inputSchema": {
            "type": "object",
            "properties": {
                "out_dir": {"type": "string", "description": "输出目录, 默认 ~/.genshen-cp6/wallpapers"},
