...
SKIP_DIRS = {".git", "__pycache__", "build", ".eggs",
             "genshen_skin_cp6.egg-info", "node_modules", ".vscode-test"}
SKIP_SUFFIX = (".pyc", ".pyo", ".bak", ".orig", ".rej")
SKIP_FILES = {".mcp.json"}
SKIP_PREFIX = ("genshen_skin_cp6-",)
...
def collect(root):
    ...
    build 期的 genshen_skin_cp6-0.1.0/ 源码副本、__pycache__ 等一律排除。
    """
    out = []
...
def main():
    ...
    ap.add_argument("--message", default="feat: 原神CP壁纸套件2 · 玛拉妮×基尼奇×卡其娜")
